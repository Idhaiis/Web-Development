...
*   **Modern UI:** A beautiful gradient background with a clean, card-based interface.

## 🛠️ Technologies Used

*   **HTML5:** For the structure of the application.
*   **CSS3:** For styling, layouts, and custom UI elements.
*   **JavaScript (Vanilla):** For DOM manipulation, event handling, and Local Storage integration.
...
*Designed and developed with HTML, CSS, and JS.*
